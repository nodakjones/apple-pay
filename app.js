...
app.post('/validate-merchant', async (req, res) => {
    try {
        ...
        const merchantId = 'merchant.obliging-quagga-evidently.ngrok-free.app'; // Replace with your actual merchant ID
        const merchantCertPath = path.join(__dirname, 'certs', 'nodejsappmerhantid.pem');
        const merchantKeyPath = path.join(__dirname, 'certs', 'mainkey.key');
        ...
        const validationPayload = {
            ...
            displayName: 'StoreName', // Replace with your store name
            initiative: 'web',
        ...
        const response = await axios.post(validationURL, validationPayload, {
            ...
            httpsAgent: new (require('https').Agent)({
                cert: cert,
                key: key,
                passphrase: '27089546' // Add passphrase if your key is encrypted
            })
        });
